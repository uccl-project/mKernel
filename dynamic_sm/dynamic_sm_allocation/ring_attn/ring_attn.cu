...
template <bool LaunchBarrier = true>
void entrypoint_impl(
    const at::Tensor &Q,
...
void entrypoint(
    ...
    entrypoint_impl<true>(Q, K0, K1, V0, V1, L, L_block, O, O_block, barrier, ring_stage, num_comm_sms);
}

void entrypoint_no_barrier(
    const at::Tensor &Q,
    kittens::py::TKParallelTensor &K0,
    kittens::py::TKParallelTensor &K1,
    kittens::py::TKParallelTensor &V0,
    ...
    entrypoint_impl<false>(Q, K0, K1, V0, V1, L, L_block, O, O_block, barrier, ring_stage, num_comm_sms);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("tk_mha_fwd_d128_no_barrier", &entrypoint_no_barrier);
}
